...
class acLSTM(nn.Module):
    ...
    def calculate_loss(self, out_seq, groundtruth_seq):
        ...
        return quaternion_loss(out_seq, groundtruth_seq)
...
def train_one_iteraton(real_seq_np, model, optimizer, iteration, save_dance_folder, print_loss=False,
    ...
    if (save_bvh_motion == True):
        ...
        read_bvh.get_quad_data_from_npy(save_dance_folder + "%07d" % iteration + "_gt.bvh", gt_seq)
        read_bvh.get_quad_data_from_npy(save_dance_folder + "%07d" % iteration + "_out.bvh", out_seq)
...
# read_weight_path = "train_weight_aclstm_martial/quad_weights_mse/0009000.weight"
# write_weight_folder = "train_weight_aclstm_martial/quad_weights_mse/"
# write_bvh_motion_folder = "train_tmp_bvh_aclstm_martial/quad_tmp_mse/"
# dances_folder = "train_data_quad/martial/"
# loss_log = "train_loss_aclstm_martial/quad_loss_mse.txt"



# quat
read_weight_path = ""
write_weight_folder = "train_weight_aclstm_martial/quad_weights_quat_loss/"
write_bvh_motion_folder = "train_tmp_bvh_aclstm_martial/quad_tmp_quat_loss/"
dances_folder = "train_data_quad/martial/"
loss_log = "train_loss_aclstm_martial/quad_loss_quat_loss.txt"
