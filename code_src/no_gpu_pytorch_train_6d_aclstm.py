...
def train_one_iteraton(real_seq_np, model, optimizer, iteration, save_dance_folder, print_loss=False,
    ...
    if (save_bvh_motion == True):
        ...
        read_bvh.get_6d_data_from_npy(save_dance_folder + "%07d" % iteration + "_gt.bvh", gt_seq)
        read_bvh.get_6d_data_from_npy(save_dance_folder + "%07d" % iteration + "_out.bvh", out_seq)
...
read_weight_path = ""
write_weight_folder = "train_weight_aclstm_martial/6d_weights/"
write_bvh_motion_folder = "train_tmp_bvh_aclstm_martial/6d_tmp/"
