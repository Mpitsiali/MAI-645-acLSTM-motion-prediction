...
def test(dance_batch_np, frame_rate, batch, initial_seq_len, generate_frames_number, read_weight_path,
    ...
    for b in range(batch):
        ...
        if (start_id + generate_frames_number+ initial_seq_len) > len(dance): #make sure that it can generate generate_frames_number amount
    ...
    for i, item in enumerate(gt_start_id):
        ...
        read_bvh.write_traindata_to_bvh(write_bvh_motion_folder+"gt"+"%02d"%i+".bvh", np.array(gt_dance_sample))
...
# MSE
# read_weight_path="train_weight_aclstm_martial/pos_weights_mse/0020000.weight"
# write_bvh_motion_folder = "test_bvh_aclstm_martial/pos_mse/"
#
# dances_folder = "train_data_xyz/martial/"


# AD
read_weight_path="train_weight_aclstm_martial/pos_weights_angle_distance/0004000.weight"
write_bvh_motion_folder = "test_bvh_aclstm_martial/pos_ad/"
dances_folder = "train_data_xyz/martial/"
