...
def train_one_iteraton(real_seq_np, model, optimizer, iteration, save_dance_folder, print_loss=False, save_bvh_motion=True):
    ...
    predict_groundtruth_seq = torch.autograd.Variable(torch.FloatTensor(real_seq_dif_hip_x_z_np[:, 1:seq_len+1].tolist())).view(real_seq_np.shape[0], -1)
...
# read_weight_path = "train_weight_aclstm_martial/0000000.weight"
read_weight_path = ""
write_weight_folder = "train_weight_aclstm_martial/pos_weights_angle_distance/"
write_bvh_motion_folder = "train_tmp_bvh_aclstm_martial/pos_tmp_angle_distance/"
dances_folder = "train_data_xyz/martial/"
loss_log = "train_loss_aclstm_martial/poss_loss_angle_distance.txt"
dance_frame_rate = 60
batch = 32
in_frame = 171
out_frame = 171
