...
def generate_seq(initial_seq_np, generate_frames_number, model, save_dance_folder):
    ...
    for b in range(batch):
        ...
        read_bvh.get_quad_data_from_npy(save_dance_folder + "out" + "%02d" % b + ".bvh", out_seq)
...
def test(dance_batch_np, frame_rate, batch, initial_seq_len, generate_frames_number, read_weight_path,
    ...
    for i, item in enumerate(gt_start_id):
        ...
        read_bvh.get_quad_data_from_npy(write_bvh_motion_folder + "gt" + "%02d" % i + ".bvh", np.array(gt_dance_sample))
...
# Quaternion loss
# read_weight_path = "train_weight_aclstm_martial/quad_weights_quat_loss/0020000.weight"
# write_bvh_motion_folder = "test_bvh_aclstm_martial/quad_quat_loss/"
# dances_folder = "train_data_quad/martial/"


# MSE
read_weight_path = "train_weight_aclstm_martial/quad_weights_mse/0020000.weight"
write_bvh_motion_folder = "test_bvh_aclstm_martial/quad_mse/"
dances_folder = "train_data_quad/martial/"
